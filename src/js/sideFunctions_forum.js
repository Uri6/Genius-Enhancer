...
export function replaceButtons(createDiscussion, follow) {
    if (createDiscussion) {
        const createDiscussionElement =
            document.getElementsByClassName("create_discussion");
    ...
    if (follow) {
        const unfollowElement = document.getElementsByClassName(
            "new_status_unfollow"
        );
        ...
        const followElement =
            document.getElementsByClassName("new_status_follow");
