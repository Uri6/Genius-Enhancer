...
import "../../lib/hot-reload.ts";

import { identifyPageType, replaceTextarea, removeQuill } from "./sideFunctions.js";
...
import tagifyStyle from "../../lib/tagify/tagify.scss";
import { geniusAddress } from "./utils";
...
chrome.tabs.onUpdated.addListener(async (tabId, changeInfo, tab) => {
    ...
    if (changeInfo.status === 'complete' && tab.url.includes("genius.com")) {
        ...
        if (isGeniusPage) {
            const pageType = await identifyPageType()
