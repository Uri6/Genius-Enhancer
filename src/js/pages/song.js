...
import geniusSpot from "../sideFunctions/geniuspot";
import $ from "jquery";
import "../../../secrets.js";

geniusSpot();

// TODO: this all needs to be refactored out
...
const options = [
    {
        id: "created|edited|proposed_an_edit_to|merged|accepted|rejected|deleted|pinned",
