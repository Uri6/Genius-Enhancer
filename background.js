...
chrome.tabs.onUpdated.addListener((tabId, changeInfo, tab) => {
    ...
    if (changeInfo.status === "complete" && tab.url.includes("genius.com")) {
        ...
        const jsFiles = files.filter((f) => f.type === "js").map((f) => f.file);
            ...
            new Promise((resolve, reject) => {
                ...
                chrome.scripting.executeScript({
                    ...
                    func: () => {
                        ...
                        var subNav = $(
                            ".PageHeaderdesktop__Subnavigation-bhx5ui-6.koeYQd"
                        );
                        if (subNav.length == 0) {
                            subNav = $(".header-nav_menu");
                        }
                        var logo = $(
                            ".PageHeaderLogo__Link-sc-175tsd3-0.jNXEyt"
                        );
                        if (logo.length == 0) {
                            logo = $(".logo_container");
                        }
                        ...
                        if (searchBar.length == 0) {
                            searchBar = $(
                                ".quick_search.search.quick_search--header"
                            );
                        }
                        ...
                        const elementsToScroll = {
                            "/#top-songs": $(
                                ".HomeContentdesktop__Section-sc-1xfg7l1-4.bBDcg"
                            ),
                            "/#featured-stories": $(
                                ".PageGriddesktop-a6v82w-0.csQZGy"
                            ),
                            "/#videos": $(
                                ".HomeContentdesktop__Section-sc-1xfg7l1-4.gveVlf"
                            ),
                        };

                        $(document).on(
                            "click",
                            ".PageHeaderdesktop__Link-bhx5ui-4.jQULAr",
                            function (e) {
                        ...
                        $(document).on("DOMNodeInserted", (e) => {
                            if (
                                $(
                                    ".search_results_autocomplete_container .feed_dropdown"
                                ).hasClass("feed_dropdown--left_align")
                            ) {
                                $(
                                    ".search_results_autocomplete_container .feed_dropdown"
                                ).removeClass("feed_dropdown--left_align");
                            }
                            ...
                            setTimeout(() => {
                                if (
                                    ...
                                    $(e.target).find(".modal_window-content")
                                        .length > 0 &&
                                    ($(e.target)
                                        .find(".modal_window-content")
                                        .find("conversation-with-user").length >
                                        0 ||
                                        $(e.target)
                                            .find(".modal_window-content")
                                    ...
                                    const oldCloseButton = $(e.target).find(
                                    ...
                                    const closeIconSource =
                                        chrome.runtime.getURL(CloseIcon);
                                    ...
                                    closeButton.setAttribute(
                                        "onmouseover",
                                        "this.src='" +
                                            chrome.runtime.getURL(CloseIconX) +
                                            "'"
                                    );
                                    closeButton.setAttribute(
                                        "onmouseout",
                                        "this.src='" + closeIconSource + "'"
                                    );
                    ...
                    switch (pageType) {
                        case "new song":
                            ...
                            chrome.scripting.executeScript({
                                target: { tabId: tabId },
                                func: () => {
                                    const oldChooser = document.querySelector(
                                        ".primary_tag_chooser"
                                    );
                                    ...
                                    genres.forEach((genre) => {
                                        ...
                                        genreButton.addEventListener(
                                            ...
                                            (e) => {
                                                ...
                                                $(
                                                    `#song_primary_tag_id_${genre.value}`
                                                ).click();
                                            }
                                        );
                                    ...
                                    const styleGuide = document.querySelector(
                                        ".lyrics_style_guide"
                                    );
                                    const h4 = styleGuide.querySelector("h4");
                                    styleGuide.parentElement.insertBefore(
                                        h4,
                                        styleGuide
                                    );
                                        ...
                                        .addEventListener(
                                            ...
                                            async (e) => {
                                                ...
                                                if (
                                                    ...
                                                    e.preventDefault();
                                                    $(lyricsTextarea).addClass(
                                                        "missing"
                                                    );

                                                    lyricsTextarea.addEventListener(
                                                        "input",
                                                        (e) => {
                                                            $(
                                                                e.target
                        ...
                        case "firehose":
                            ...
                            chrome.scripting.executeScript({
                                target: { tabId: tabId },
                                func: () => {
                                    $("fieldset input[type='checkbox']").each(
                                        function () {
                        ...
                        case "home":
                            chrome.scripting.executeScript({
                                ...
                                func: () => {
                                    ...
                                    var container = $(
                                        ".HomeContentdesktop__Container-sc-1xfg7l1-0.zvOxT"
                                    );
                                    ...
                                    document
                                        .querySelectorAll(
                                            ".qsIlk, .dUTFUv, .kcEpRx, .jdaOmt, .klrmXf"
                                        )
                                        .forEach(function (e) {
                                            $(e).append(
                                    ...
                                    $(".SquareButton-sc-109lda7-0.hlrLfQ")
                                        .last()
                                        .click();
                                    ...
                                    $(".jHQizl .kMmimq").mousemove(function (
                                        e
                                    ) {
                                        ...
                                        $(this)
                                            .find(
                                                ".SizedImage__Container-sc-1hyeaua-0"
                                            )
                                            .css({
                                                transform:
                                                    "translate(" +
                                    ...
                                    $(".jHQizl .kMmimq").mouseleave(function (
                                        e
                                    ) {
                                        $(this)
                                            .find(
                                    ...
                                    remove.bg.removeBackgroundFromImage(
                                        img,
                                        (result) => {
                            ...
                            chrome.scripting.executeScript({
                                ...
                                func: () => {
                                    ...
                                    getTagsList().then((res) => {
                                        ...
                                        const dataListElem = $("<datalist>")
                                            .html(res.innerHTML)
                                            .attr("id", "tagsList");
                                        const options =
                                            dataListElem.find("option");

                                        options.each(function () {
                                            const tagNameFixed = $(this)
                                                .html()
                                                .replace(
                                                    /&[\w\d#]{2,5};/g,
                                    ...
                                    if (
                                        $(
                                            ".header_with_cover_art metadata .metadata_unit"
                                        ).length
                                    ) {
                                        $(
                                            ".header_with_cover_art metadata .metadata_unit"
                                            ...
                                            $(
                                                ".header_with_cover_art .metadata_unit"
                                            )
                                                .text()
                                                .replace("Released ", "")
                                        );
                        ...
                        case "song":
                            ...
                            chrome.scripting.executeScript({
                                ...
                                func: () => {
                                    $(document).on(
                                        "DOMNodeInserted",
                                        ".Modalshared__ModalSharedContainer-knew3e-0.Modaldesktop__Container-sc-1e03w42-0.cJpfVu",
                                        function (e) {
                                            if (
                                                !$(
                                                    ".RecentActivity__FilteringContainer"
                                                ).length
                                            ) {
                                                ...
                                                const options = [
                                                    {
                                                        id: "created|edited|merged|accepted|rejected|deleted|pinned",
                                                        text: "Annotations, Proposals, Q&A",
                                                    },
                                                    {
                                                        id: "added_a_suggestion_to|replied_to|integrated|archived|marked",
                                                    ...
                                                    {
                                                        id: "edited_the_lyrics_of|recognized|marked_complete|verified_the_lyrics_of|unverified_the_lyrics_of",
                                                        text: "Lyrics Edits",
                                                    },
                                                    {
                                                        id: "edited_the_metadata_of|locked|unlocked",
                                                        text: "Metadata",
                                                    },
                                                    {
                                                        id: "pyonged",
                                                ...
                                                $(e.target)
                                                    .find(
                                                        ".RecentActivity__Title-d62qa5-1.ilJdac"
                                                    )
                                                    .after(filterContainer);
                                                ...
                                                $(
                                                    ".RecentActivity__FilteringDropdownItem"
                                                ).click(function () {
                                                    $(this)
                                                        .find(".chkboxm")
                                                        .prop(
                                                ...
                                                $(filterDropdown)
                                                    ...
                                                    .click(function () {
                                                        ...
                                                        const iframe =
                                                            document.querySelector(
                                                                ".PlaceholderSpinnerIframe__Iframe-sc-1vue620-0"
                                                            );
                                                        ...
                                                        activityItems.forEach(
                                                            (activityItem) => {
                                                                ...
                                                                if (
                                                                    ...
                                                                    actionType =
                                                                        activityItem.querySelector(
                                                                            "inbox-line-item-action-icon div"
                                                                        );
                                                                    if (
                                                                        actionType &&
                                                        ...
                                                        const checkedFilters =
                                                            document.querySelectorAll(
                                                                ".RecentActivity__FilteringDropdownItem input:checked"
                                                            );
                                                        const checkedFiltersIds =
                                                            Array.from(
                                                                checkedFilters
                                                            )
                                                                .map(
                                                                    (
                                                                        ...
                                                                        checkedFilter.getAttribute(
                                                                            "filter-id"
                                                                        )
                                                                )
                                                                .join("|");
                                                        const checkedFiltersDiv =
                                                            iframe.contentWindow.document.querySelector(
                                                                ".checked-filters"
                                                            );
                                    ...
                                    if (
                                        ...
                                        !!document.getElementsByClassName(
                                            "Annotation__Container-l76qjh-0 cNCMgo"
                                        ).length
                                    ) {
                                        isAnnotation = true;
                                    }
                                    ...
                                    if (mostUsedLanguage === null) {
                                        ...
                                        var direction = isRTL(mostUsedLanguage)
                                            ? "RTL"
                                            : "LTR";
                                        console.log(
                                            "Most used language: " +
                        ...
                        case "forums (main)":
                            ...
                            chrome.scripting.executeScript({
                                ...
                                func: () => {
                                    ...
                                    $(document).on(
                                        "keypress",
                                        ".discussions_search_bar-text_input",
                                        function (e) {
                                            if (e.which == 13) {
                                                if (this.value.length < 3) {
                                                    ...
                                                    if (
                                                        !document.getElementsByClassName(
                                                            "discussions_search_bar-text_input-error"
                                                        ).length
                                                    ) {
                                                        var span =
                                                        ...
                                                        span.textContent =
                                                            "The input is too short (min 3 characters)";
                                                        span.setAttribute(
                                                            "class",
                                                            "discussions_search_bar-text_input-error"
                                                        );
                            ...
                            chrome.scripting.executeScript({
                                ...
                                func: () => {
                                    ...
                                    if (document.readyState === "complete") {
                                        $(".reply_container h3").replaceWith(
                                            '<h3 class="comment-title">Comment</h3>'
                                        );
                                        $(".forum_post_container .avatar")
                                            .first()
                                            .removeClass("small");
                                        $(".user_badge")
                                            .first()
                                            .addClass("first_one");
                                        $(".body.embedly.embedly_pro")
                                            .first()
                                            .addClass("first_one");
                                        $("#groups_sidebar").remove();
                                        $(".group_summary").insertBefore(
                                            "#container.mecha--deprecated"
                                        );
                                        $(
                                            ".discussion_thread-discussion_and_group_list"
                                        ).insertAfter(".group_summary");
                                        $(
                                            "#group_container.discussion_thread"
                                        ).insertAfter(
                                            ".discussion_thread-discussion_and_group_list"
                                        );
                                        $(".group_summary")
                                            .attr(
                                                "onclick",
                                                "window.location.href=$('.group_summary a').attr('href')"
                                            )
                                            .css("cursor", "pointer");

                                        // Restyling the header of the post
                                        if (
                                            $(".group_title-moderation_actions")
                                                .length
                                        ) {
                                            $(
                                                ".group_title-moderation_actions"
                                                ...
                                                $(
                                                    ".forum_post-header .voting_links"
                                                ).first()
                                            );
                                            $(
                                                ".forum_post-header .voting_links"
                                        ...
                                        $(
                                            ".body.embedly.embedly_pro.first_one"
                                        ).css(
                                            "margin-top",
                                            $(
                                                ".body.embedly.embedly_pro.first_one"
                                        ...
                                        $(
                                            ".forum_post_container .forum_post_unit:not(:first-child)"
                                        ).each(function () {
                                            addReplyButton(this);
                                        });
                                        ...
                                        function addReplyButton(forumPostUnit) {
                                            ...
                                            replyButton.innerHTML =
                                                '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" height="24" width="24"><path d="M10 9V5l-7 7 7 7v-4.1c5 0 8.5 1.6 11 5.1-1-5-4-10-11-11z"/></svg>';

                                            replyButton.addEventListener(
                                                "click",
                                                function () {
                                                    const iqValue =
                                                        forumPostUnit.querySelector(
                                                            ".iq_value"
                                                        );
                                                    if (!iqValue) {
                                                        console.error(
                                        ...
                                        if (userTooltip.length) {
                                            const toggleFollowBtn =
                                                userTooltip.find(
                                                    ".toggle_follow.button.new_status_unfollow"
                                                );
                                            if (toggleFollowBtn.length) {
                                                const helperText =
                                                    toggleFollowBtn.find(
                                                        ".toggle_follow-helper_text"
                                                    );
