...
! function (t, e) {
  ...
  class Bt extends R {
    ...
    getTipElement() {
      ...
      const t = document.createElement("div");
      t.append(this._config.template);
    ...
    setElementContent(t, e) {
      if (null !== t) return a(e) ? (e = l(e), void (this._config.html ? e.parentNode !== t && (t.html(""), t.append(e)) : t.textContent = e.textContent)) : void (this._config.html ? (this._config.sanitize && (e = It(e, this._config.allowList, this._config.sanitizeFn)), t.html(e)) : t.textContent = e)
    }
    getTitle() {
